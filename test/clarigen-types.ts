...
extAllowContractCallerPox4: {
  ...
  contractName: 'ext-allow-contract-caller-pox-4',
  },
extDelegateStxPox4: {
  "functions": {
    call: {"name":"call","access":"public","args":[{"name":"payload","type":{"buffer":{"length":2048}}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[payload: TypedAbiArg<Uint8Array, "payload">], Response<boolean, bigint>>,
...
standardRules: {
  "functions": {
    ...
    getWeeklyAmount: {"name":"get-weekly-amount","access":"read_only","args":[],"outputs":{"type":"uint128"}} as TypedAbiFunction<[], bigint>
  },
  "maps": {
