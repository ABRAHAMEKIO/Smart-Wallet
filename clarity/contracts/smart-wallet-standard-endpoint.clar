...
(define-public (delegate-stx (sm <wallet-trait>) (amount uint) (to principal))
    (contract-call? sm extension-call .ext-delegate-stx-pox-4 (unwrap! (to-consensus-buff? 
        {action: "delegate",
                    amount-ustx: amount, 
                    delegate-to: to, 
                    until-burn-ht: none,
...
(define-public (revoke-delegate-stx (sm <wallet-trait>))
    (contract-call? sm extension-call .ext-delegate-stx-pox-4 (unwrap! (to-consensus-buff? 
    {action: "revoke",
                    amount-ustx: u0, 
